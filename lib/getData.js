    ...
    .get(api, function(res) {
      ...
      res.on("end", function() {
        ...
        for (i = 0; i < result.Events.length; i++) {
          aEvent = result.Events[i];
          aEvent.Id = undefined;
          aEvent.Venue.Id = undefined;
          aEvent.Venue.CountryCode = undefined;
          aEvent.Venue.Country = undefined;
          aEvent.Venue.State = undefined;
          aEvent.Venue.Latitude = undefined;
          aEvent.Venue.Longitude =undefined;
          for (i = 0; i < aEvent.Artists.length; i++) {
           aEvent.Artists[i].Id = undefined;
          }
           data.push(aEvent);
          }
        page = page + 1;

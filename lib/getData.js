    ...
    .get(api, function(res) {
      ...
      res.on("end", function() {
        ...
        for (i = 0; i < result.Events.length; i++) {
          ...
          delete  aEvent.Id;
          delete  aEvent.Venue.Id;
          delete  aEvent.Venue.CountryCode;
          delete  aEvent.Venue.Country;
          delete  aEvent.Venue.State;
          delete  aEvent.Venue.Latitude;
          delete  aEvent.Venue.Longitude;
          for (i = 0; i < aEvent.Artists.length; i++) {
           delete aEvent.Artists[i].Id;
          }
           data.push(aEvent);
          }
        page = page + 1;
